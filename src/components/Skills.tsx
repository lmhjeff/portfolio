...
const Skills = ({ skills }: Props) => {
    return (
        <motion.div
            ...
            <h3 className="uppercase absolute top-12 md:top-24 tracking-[20px] text-gray-500 text-2xl">Skills</h3>
            <h3 className="absolute top-28 md:top-36 uppercase tracking-[3px] text-gray-500 text-sm">
                Hover over sa skill for current profieciency
            </h3>
